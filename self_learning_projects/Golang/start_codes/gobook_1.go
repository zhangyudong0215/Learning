...
// // 在上述代码基础上实现估算众数和标准差，众数自己写的，标准差参考答案
...
// <tr><td>Std</td><td>%f</td></tr>
// </table>`, stats.numbers, len(stats.numbers), stats.mean, stats.median,
// 		stats.modes, stats.std)
// }
...
// 	var mean float64 = sum(numbers) / float64(len(numbers))
// 	var len_ float64 = float64(len(numbers) - 1)
// 	var sum_ float64
// 	for _, num := range numbers {
// 		sum_ += math.Pow((num - mean), 2)
// 	}
// 	return math.Sqrt(sum_ / len_)
// }

// func modes(numbers []float64) (modes []float64) {
